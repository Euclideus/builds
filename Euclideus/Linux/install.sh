...
cp "$SCRIPT_DIR/squashfs-root/usr/share/desktop-deployment/euclideus_icon.png" "$ICON_DIR/"
cp "$SCRIPT_DIR/squashfs-root/usr/share/desktop-deployment/Euclideus.desktop" "$APP_DIR/"
