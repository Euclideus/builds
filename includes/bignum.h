...
BIGNUM_API bit_array *InvertSquareRootBitArray(bit_array *ba1,uint64_t precision,uint64_t *kshift,volatile char *cancel);
...
BIGNUM_API bit_array_float *DivideBitArrayFloats(bit_array_float *baf1,bit_array_float *baf2,uint64_t precision, volatile char *cancel);
...
BIGNUM_API bit_array_float *ExponentiateBitArrayFloats(bit_array_float *baf1,bit_array_float *baf2, uint64_t precision, volatile char *cancel);
...
BIGNUM_API bit_array_float *ExtendedGCDBitArrays(bit_array_float *a,bit_array_float *b,bit_array_float **x,bit_array_float **y,volatile char *cancel);
...
BIGNUM_API void EPartialSumSub(bit_array *a,bit_array *b,bit_array *baone,bit_array **p,bit_array **q,volatile char *cancel);
