...
BIGNUM_API bit_array *DivideBitArrayBy10(bit_array *ba,uint8_t *remainder, char * cancel);
BIGNUM_API bit_array *DivideBitArrayByPowerOf10(bit_array *ba,uint64_t pow10, char * cancel);
BIGNUM_API bit_array *MultiplyBitArrayBy10(bit_array *ba,uint8_t *int_part, char * cancel);
BIGNUM_API char *BitArrayToDecimalFractionalString(bit_array *ba, uint64_t ndecimals, char * cancel);
BIGNUM_API bit_array **GetPowerOf10BitArrays(uint64_t powmax, char * cancel);
...
BIGNUM_API char *BitArrayToDecimalIntegerString(bit_array *ba, char * cancel);
BIGNUM_API char *DivideBy2(char *dec, char * cancel);
BIGNUM_API char *MultiplyBy2(char *dec, char * cancel);
BIGNUM_API bit_array *DecimalIntegerStringToBitArray(char *dec, char * cancel);
BIGNUM_API bit_array_float *InitializeBitArrayFloatFromHexadecimal(char *floatval);
BIGNUM_API bit_array_float *InitializeBitArrayFloatFromDecimal(char *floatval,uint64_t precision, char * cancel);
BIGNUM_API bit_array *DecimalFractionalStringToBitArray(char *dec,uint64_t max_precision, char * cancel);
...
BIGNUM_API bit_array_float *ExponentiateBitArrayFloats(bit_array_float *baf1,bit_array_float *baf2, char * cancel);
...
BIGNUM_API char* PrintBitArrayFloatToDecimal(bit_array_float*, int32_t sigdigits, char * cancel);
