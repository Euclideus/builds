...
ARB_API cmplx *CauchyFFTDerivatives(cmplx(*)(cmplx,void *),cmplx,void *,int32_t,int32_t,int32_t);
ARB_API cmplx **CauchyTaylorFFTMatrixFunc(cmplx(*)(cmplx,void *),void *,cmplx **,int32_t);
...
ARB_API double FindContourRadius(cmplx(*)(cmplx,void *),cmplx,void *,int32_t);
