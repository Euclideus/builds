...
ARB_API cmplx *CauchyFFTDerivatives(cmplx(*)(cmplx,void *),cmplx,void *,int32_t,int32_t,int32_t,char *);
ARB_API cmplx **CauchyTaylorFFTMatrixFunc(cmplx(*)(cmplx,void *),void *,cmplx **,int32_t,char *);
...
ARB_API double FindContourRadius(cmplx(*)(cmplx,void *),cmplx,void *,int32_t,char *);
...
ARB_API cmplx **MatrixCosFunc(cmplx **,char *);
ARB_API cmplx **MatrixCoshFunc(cmplx **,char *);
...
ARB_API cmplx **MatrixExponentialFunc(cmplx **,char *);
ARB_API cmplx **MatrixBasicFunc(cmplx(*)(cmplx),cmplx **(*)(cmplx **),cmplx **,char *);
ARB_API cmplx **MatrixArccosFunc(cmplx **,char *);
ARB_API cmplx **MatrixArccoshFunc(cmplx **,char *);
ARB_API cmplx **MatrixArcsinFunc(cmplx **,char *);
ARB_API cmplx **MatrixArcsinhFunc(cmplx **,char *);
ARB_API cmplx **MatrixArctanFunc(cmplx **,char *);
ARB_API cmplx **MatrixArctanhFunc(cmplx **,char *);
...
ARB_API cmplx **MatrixFunc(cmplx(*)(cmplx,void *),void *,cmplx **,int32_t,char *);
...
ARB_API cmplx **MatrixLogFunc(cmplx **,char *);
ARB_API cmplx **MatrixPow(cmplx **,cmplx **,char *);
cmplx **MatrixPowMS(cmplx **,cmplx,char *);
cmplx **MatrixPowSM(cmplx,cmplx **,char *);
...
ARB_API cmplx **MatrixSinFunc(cmplx **,char *);
ARB_API cmplx **MatrixSinhFunc(cmplx **,char *);
ARB_API cmplx **MatrixTanFunc(cmplx **,char *);
ARB_API cmplx **MatrixTanhFunc(cmplx **,char *);
